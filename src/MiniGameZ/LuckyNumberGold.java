...
public class LuckyNumberGold {
    ...
    public static String showOneResult() {
        return !MiniGameZ.LuckyNumber.DATA_RESULT.isEmpty() ? MiniGameZ.LuckyNumber.DATA_RESULT.get(MiniGameZ.LuckyNumber.DATA_RESULT.size() - 1).toString().formatted("%02d") : "";
    }

    public static String showTenResult() {
        StringBuilder previousResults = new StringBuilder();
        List<Integer> dataKQ_CSMM = MiniGameZ.LuckyNumber.DATA_RESULT;
    ...
    public static String showTenPlayResult() {
        StringBuilder previousResults = new StringBuilder();
        List<String> dataKQ_CSMM = MiniGameZ.LuckyNumber.DATA_PLAYER_RESULT;
