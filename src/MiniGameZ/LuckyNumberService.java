...
public class LuckyNumberService {
    ...
    public static void addData(Player player, int number, boolean isGem) {
        ...
        data.isGem = isGem;
        data.isReward = false;
        MiniGameZ.LuckyNumber.players.add(data);
    ...
    public static List listNumberSelect(Player pl) {
        ...
        for (LuckNumberData data : MiniGameZ.LuckyNumber.players) {
            if (data.id == pl.id) {
    ...
    public static String strNumber(long id) {
        String number = "";
        List<LuckNumberData> pl = MiniGameZ.LuckyNumber.players.stream().filter(d -> d.id == id).toList();
    ...
    public static void addNumber(Player pl, int number) {
        ...
        if (MiniGameZ.LuckyNumber.players.stream().filter(d -> d.id == pl.id).toList().size() >= 10) {
