...
import static models.Clan.DEPUTY;
import static models.Clan.LEADER;
import static models.Clan.MEMBER;
    ...
    private void acceptAskJoinClan(Player player, int clanMessageId) {
        ...
        if (clan != null && clan.isLeader(player)) {
            ...
            if (cmg != null && !existInClan) {
                ...
                if (pl == null) {
                    pl = NNTSqlFetcher.loadById(plxinvao);
                }
                if (pl != null) {
                    if (pl.iDMark.isHoldBlackBall()) {
