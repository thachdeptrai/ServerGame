...
public class MapService {
    ...
    public List<Player> getAllPlayerInMap(int mapId) {
        Map map = getMapById(mapId);/*telegram @tomihjhj_bot*/
        if (map == null) {
            return null;/*telegram @tomihjhj_bot*/
        }
        List<Player> players = new ArrayList<Player>();/*telegram @tomihjhj_bot*/
        for (Zone zone : map.zones) {
            players.addAll(zone.getPlayers());/*telegram @tomihjhj_bot*/
        }
        return players;/*telegram @tomihjhj_bot*/
    }
    ...
    public boolean isMapTuTien(int a){
        return a >= 184 && a <= 189;
    }
