...
import ComBine.DapDoAoHoa;
import ComBine.EpSaoTrangBi;
import ComBine.GiaHanVatPham;
import ComBine.GiamDinhSach;
import ComBine.HoiPhucSach;
import ComBine.MoKhoaItem;
import ComBine.NangCapBongTai;
import ComBine.NangCapChanMenh;
import ComBine.NangCapKichHoat;
import ComBine.NangCapKichHoatVip;
import ComBine.NangCapLinhThach;
...
import ComBine.NangGiapLuyenTap;
import ComBine.NhapNgocRong;
import ComBine.PhaLeHoaTrangBi;
import ComBine.PhanRaSach;
import ComBine.PhapSuHoa;
import ComBine.RemoveOptionItem;
import ComBine.SieuHoaCaiTrang;
import ComBine.TaoDaHematite;
import ComBine.TaySach;
import ComBine.TinhAnTrangBi;
import ComBine.TinhThachHoa;
...
public class CombineService {
    ...
    public static final int NANG_CAP_LINH_THACH = 530;
    ...
    public void showInfoCombine(Player player, int[] index) {
        ...
        switch (player.combine.typeCombine) {
            ...
            case NANG_CAP_LINH_THACH ->
                NangCapLinhThach.showInfoCombineNLT(player);
    ...
    public void startCombine(Player player, int... n) {
        ...
        switch (player.combine.typeCombine) {
            ...
            case NANG_CAP_LINH_THACH->{
                NangCapLinhThach.nhapLinhThach(player);
//                System.out.println("abc chay den ham này");
            }
...
//            msg.writer().writeShort(-1); // y
    ...
    public void sendAddItemCombine(Player player, int npcId, Item... items) {
        ...
        try {
            msg = new Message(-81);
            msg.writer().writeByte(0);
            msg.writer().writeUTF("By NgocThach");
            msg.writer().writeUTF("Ngoc Thach - Đẹp Trai Là Không Có Gì Bàn Cãi");
    ...
    private String getTextTopTabCombine(int type) {
        return switch (type) {
            ...
            case NANG_CAP_LINH_THACH ->
                "Ta sẽ phù phép\ncho 1000 viên Linh Thạch \nthành 1 viên Linh Thạch cấp cao hơn\n Có tỉ lệ thấp sẽ nhảy cấp nếu ngươi may mắn";
            default ->
                "";
        };
    }
    ...
    private String getTextInfoTabCombine(int type) {
        return switch (type) {
            ...
            case NANG_GIAP_LUYEN_TAP ->
                ...
                + "Sau đó chọn 'Nâng Cấp'";
            case NANG_CAP_LINH_THACH ->
                "Vào hành trang\nChọn 1000 viên Linh Thạch cùng Cấp\nSau đó chọn 'Làm phép'";
            default ->
                "";
        };
    }
