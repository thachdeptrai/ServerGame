...
import models.TreasureUnderSea;
import models.SnakeWay;
import models.DestronGas;
...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isUseHOIXUANDAN) {
            sendItemTime(player, 21650, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeHOIXUANDAN)) / 1000));
        }
        if (player.itemTime.isUseCUUCHUYENKIMDAN) {
            sendItemTime(player, 21649, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeCUUCHUYENKIMDAN)) / 1000));
        }
        if (player.itemTime.isUseNGUNGTHANDAN) {
            sendItemTime(player, 20898, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeNGUNGTHANDAN)) / 1000));
        }
        if (player.itemTime.isUseBOHUYETDAN) {
            sendItemTime(player, 21900, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeBOHUYETDAN)) / 1000));
        }
        if (player.itemTime.isUseTHANTAMDAN) {
            sendItemTime(player, 20633, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeTHANTAMDAN)) / 1000));
        }
        if (player.itemTime.isUseLINHHUDAN) {
            sendItemTime(player, 20612, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeLINHHUDAN)) / 1000));
        }
        if (player.itemTime.isUseTRUTIENDAN) {
            sendItemTime(player, 15045, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeTRUTIENDAN)) / 1000));
        }
        if (player.itemTime.isUseHOALONGDAN) {
            sendItemTime(player, 14259, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeHOALONGDAN)) / 1000));
        }
        if (player.itemTime.isUseTHIENMENHDAN) {
            sendItemTime(player, 12315, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeTHIENMENHDAN)) / 1000));
        }
        if (player.itemTime.isUseDIEUAMDAN) {
            sendItemTime(player, 9602, (int) ((TIME_30P- (System.currentTimeMillis() - player.itemTime.lastTimeDIEUAMDAN)) / 1000));
        }
