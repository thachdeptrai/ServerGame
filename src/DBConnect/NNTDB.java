...
public class NNTDB {
    ...
    public static NTTResultSet executeQuery(String query) throws Exception {
        try (Connection connection = NNTDB.getConnectionServer(); PreparedStatement preparedStatement = connection.prepareStatement(query)) {
    ...
    public static NTTResultSet executeQuery(String query, Object... params) throws Exception {
        try (Connection connection = NNTDB.getConnectionServer(); PreparedStatement preparedStatement = connection.prepareStatement(query)) {
