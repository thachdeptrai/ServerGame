...
public class DrLychee extends Boss {
    ...
    public DrLychee(Zone zone, Clan clan, int level, double dame, double hp) throws Exception {
    ...
    public void leaveMap() {
        double bossDamage = ((this.nPoint.dame * 1.5));
        double bossMaxHealth = ((this.nPoint.hpMax * 1.5));
        try {
