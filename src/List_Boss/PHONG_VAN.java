 ...
 * @author kagam
 */
public class PHONG_VAN extends Boss {

    public long st;

    public PHONG_VAN() throws Exception {
        super( BossID.PHONGVAN,false,true, BossesData.PHONGVAN);
 ...
 @Override
    ...
    public void doneChatE() {
       ...
       for (Boss boss : this.parentBoss.bossAppearTogether[this.parentBoss.currentLevel]) {
            if ((boss.id == BossID.THIENDE ) && !boss.isDie()) {
