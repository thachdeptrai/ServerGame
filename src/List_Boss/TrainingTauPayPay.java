...
import models.TYPE_PVP;

public class TrainingTauPayPay extends TrainingBoss {

    public TrainingTauPayPay(Player player) throws Exception {
    ...
    public void checkPlayerDie(Player pl) {
        Service.gI().sendPlayerVS(playerAtt, this,ConstPlayer.PK_PVP);
    ...
    @Override
    public void afk() {
        if (Util.canDoWithTime(lastTimeAFK, 50)) {
            this.changeStatus(BossStatus.LEAVE_MAP);
        }
    }
}
