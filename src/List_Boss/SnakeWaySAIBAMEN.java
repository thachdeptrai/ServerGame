...
public class SnakeWaySAIBAMEN extends Boss {
    ...
    public SnakeWaySAIBAMEN(Zone zone, Clan clan, int id, double dame, double hp) throws Exception {
...
//                EffectSkillService.gI().removeStun(plAtt);
                ...
                setDie(this);
                die(plAtt);
                double dame =  this.nPoint.hpMax * 100L;
