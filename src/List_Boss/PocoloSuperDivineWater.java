...
public class PocoloSuperDivineWater extends Boss {
    ...
    public PocoloSuperDivineWater(Zone zone, Player player, double dame, double hp) throws Exception {
    ...
    public void autoLeaveMap() {
        ...
        if (this.isLaze && !playerCall.winSTT && Util.canDoWithTime(lastTimeLaze, 3000)) {
            ...
            try {
                ...
                msg.writer().writeDouble((1_000_000_000)); //dame ăn
