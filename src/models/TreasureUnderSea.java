...
import boss.Boss;
import List_Boss.TrungUyXanhLoBDKB;
import MapZ.TrapMap;
import MapZ.Zone;
import MobZ.Mob;
            ...
            if (zone.map.mapId == 135 || zone.map.mapId == 136 || zone.map.mapId == 137) {
                ...
                for (int i = 0; i < mobs.size(); i++) {
                    ...
                    if (((i == 5 || i == 10) && zone.map.mapId == 135) || (i == 5 && zone.map.mapId == 136) || (i == 5 && zone.map.mapId == 137)) {
                        mob.lvMob = 1;
                        mob.point.dame = ( level * 31 * 50 * mob.tempId * 10);
                        mob.point.maxHp = ( level * 3107 * 50 * mob.tempId * 10);
                        mob.hoiSinh();
                        mob.hoiSinhMobPhoBan();
                    } else {
                        mob.lvMob = 0;
                        mob.point.dame = ( level * 31 * 50 * mob.tempId);
                        mob.point.maxHp = ( level * 3107 * 50 * mob.tempId);
                        mob.hoiSinh();
                        mob.hoiSinhMobPhoBan();
                    }
                }
