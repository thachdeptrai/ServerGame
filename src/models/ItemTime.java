...
public class ItemTime {
    ...
    //đan dược
    public long lastTimeHOIXUANDAN;
    public boolean isUseHOIXUANDAN;
    public long lastTimeCUUCHUYENKIMDAN;
    public boolean isUseCUUCHUYENKIMDAN;
    public long lastTimeDIEUAMDAN;
    public boolean isUseDIEUAMDAN;
    public long lastTimeNGUNGTHANDAN;
    public boolean isUseNGUNGTHANDAN;
    public long lastTimeBOHUYETDAN;
    public boolean isUseBOHUYETDAN;
    public long lastTimeTHANTAMDAN;
    public boolean isUseTHANTAMDAN;
    public long lastTimeLINHHUDAN;
    public boolean isUseLINHHUDAN;
    public long lastTimeTRUTIENDAN;
    public boolean isUseTRUTIENDAN;
    public long lastTimeHOALONGDAN;
    public boolean isUseHOALONGDAN;
    public long lastTimeTHIENMENHDAN;
    public boolean isUseTHIENMENHDAN;
    ...
    public void update() {
        if (isUseHOIXUANDAN) {
            if (Util.canDoWithTime(lastTimeHOIXUANDAN, TIME_30P)) {
                isUseHOIXUANDAN = false;
                Service.gI().point(player);
            }
        }
        if (isUseCUUCHUYENKIMDAN) {
            if (Util.canDoWithTime(lastTimeCUUCHUYENKIMDAN, TIME_30P)) {
                isUseCUUCHUYENKIMDAN = false;
                Service.gI().point(player);
            }
        }
        if (isUseDIEUAMDAN) {
            if (Util.canDoWithTime(lastTimeDIEUAMDAN, TIME_30P)) {
                isUseDIEUAMDAN = false;
                Service.gI().point(player);
            }
        }
        if (isUseNGUNGTHANDAN) {
            if (Util.canDoWithTime(lastTimeNGUNGTHANDAN, TIME_30P)) {
                isUseNGUNGTHANDAN = false;
                Service.gI().point(player);
            }
        }
        if (isUseBOHUYETDAN) {
            if (Util.canDoWithTime(lastTimeBOHUYETDAN, TIME_30P)) {
                isUseBOHUYETDAN = false;
                Service.gI().point(player);
            }
        }
        if (isUseTHANTAMDAN) {
            if (Util.canDoWithTime(lastTimeTHANTAMDAN, TIME_30P)) {
                isUseTHANTAMDAN = false;
                Service.gI().point(player);
            }
        }
        if (isUseLINHHUDAN) {
            if (Util.canDoWithTime(lastTimeLINHHUDAN, TIME_30P)) {
                isUseLINHHUDAN = false;
                Service.gI().point(player);
            }
        }
        if (isUseTRUTIENDAN) {
            if (Util.canDoWithTime(lastTimeTRUTIENDAN, TIME_30P)) {
                isUseTRUTIENDAN = false;
                Service.gI().point(player);
            }
        }
        if (isUseHOALONGDAN) {
            if (Util.canDoWithTime(lastTimeHOALONGDAN, TIME_30P)) {
                isUseHOALONGDAN = false;
                Service.gI().point(player);
            }
        }
        if (isUseTHIENMENHDAN) {
            if (Util.canDoWithTime(lastTimeTHIENMENHDAN, TIME_30P)) {
                isUseTHIENMENHDAN = false;
                Service.gI().point(player);
            }
        }
        //========================================================================
