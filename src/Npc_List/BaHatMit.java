...
import models.DeathOrAliveArena;
...
//                                    }
                ...
                case 178 -> {
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            case 0:
                                CombineService.gI().openTabCombine(player, CombineService.NANG_CAP_LINH_THACH);
                    ...
                    switch (player.iDMark.getIndexMenu()) {
                        case ConstNpc.MENU_START_COMBINE -> {
                            switch (player.combine.typeCombine) {
                                case CombineService.NANG_CAP_LINH_THACH -> {
                                    switch (select) {
                                        case 0 ->
                                            CombineService.gI().startCombine(player);
                                    }
