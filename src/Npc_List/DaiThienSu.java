...
public class DaiThienSu extends Npc {
    ...
    public void openBaseMenu(Player player) {
        this.createOtherMenu(player, ConstMenu.MENU_SHOW,
                ...
                "Đua Top\n Sức mạnh", "Đua top\n Nạp", "Top Nhiệm Vụ","Top Hồng Ngọc");
    }
                ...
                case ConstMenu.MENU_SHOW:
                    switch (select) {
                        case 0:
                            ...
                            this.createOtherMenu(player, 1115, "|0|Đua top sức mạnh", "Xem Top", "Xem quà top", "Xem quà mốc", "Nhận quà mốc", "Đóng");
