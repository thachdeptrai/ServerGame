 ...
 * @author NgocThach
 */
import Npc_List.Rong7Sao;
import Npc_List.QuaTrung;
import Npc_List.BulmaTho;
import Npc_List.Vados;
import Npc_List.Osin;
import Npc_List.TrongTai;
import Npc_List.OngGohan;
import Npc_List.Cargo;
import Npc_List.DaiThienSu;
import Npc_List.Dende;
import Npc_List.Bulma;
import Npc_List.Rong3Sao;
import Npc_List.GhiDanh;
import Npc_List.Appule;
import Npc_List.Bill;
import Npc_List.ThanVuTru;
import Npc_List.Tapion;
import Npc_List.RongOmega;
import Npc_List.ToriBot;
import Npc_List.BaHatMit;
import Npc_List.HoaHong;
import Npc_List.QuocVuong;
import Npc_List.Rong5Sao;
import Npc_List.Rong2Sao;
import Npc_List.Rong4Sao;
import Npc_List.VuaVegeta;
import Npc_List.ThuongDe;
import Npc_List.Rong1Sao;
import Npc_List.OngParagus;
import Npc_List.Uron;
import Npc_List.Potage;
import Npc_List.Babiday;
import Npc_List.QuocVuongTranhNgoc;
import Npc_List.Whis;
import Npc_List.Rong6Sao;
import Npc_List.OngMoori;
import Npc_List.Kibit;
import Npc_List.KyGui;
import Npc_List.GokuSSJ2;
import Npc_List.DuongTang;
import Npc_List.GokuSSJ;
import Npc_List.DocNhan;
import Npc_List.BoMong;
import Npc_List.LyTieuNuong;
import Npc_List.Fide;
import Npc_List.GiuMaDauBo;
import Npc_List.LinhCanh;
import Npc_List.Karin;
import Npc_List.DauThan;
import Npc_List.MrPoPo;
import Npc_List.Bardock;
import Npc_List.Santa;
import Npc_List.QuyLaoKame;
import Npc_List.Calick;
import Npc_List.TruongLaoGuru;
import Npc_List.BulmaTuongLai;
import Npc_List.Jaco;
import Npc_List.RuongDo;
import Npc_List.DrDrief;
import Npc_List.ToSuKaio;
import Npc_List.Cui;
import boss.BossID;
...
import FunC.SummonDragon;
import static FunC.SummonDragon.SHENRON_1_STAR_WISHES_1;
import static FunC.SummonDragon.SHENRON_1_STAR_WISHES_2;
import static FunC.SummonDragon.SHENRON_SAY;

import player.Player;
import models.Item;
import JDBCMysql.NNTSqlFetcher;
import services.PVPService;
...
import utils.Logger;
import utils.Util;
import services.SuperDivineWaterService;
import services.SubMenuService;
import services.ShenronEventService;
import FunC.SummonDragonNamek;
import Npc_List.CayThongNoel;
import Npc_List.HistoryTrade;
import Npc_List.ThuongNhan;
import Npc_List.TuTien;
        ...
        try {
            return switch (tempId) {
                ...
                case ConstNpc.HISTORYTRADE ->
                    new HistoryTrade(mapId, status, cx, cy, tempId, avatar);
                case ConstNpc.TIENNHAN ->
                    new TuTien(mapId, status, cx, cy, tempId, avatar);
                case ConstNpc.THUONGNHAN ->
                    new ThuongNhan(mapId, status, cx, cy, tempId, avatar);
                case ConstNpc.CAYTHONG ->
                    new CayThongNoel(mapId, status, cx, cy, tempId, avatar);
                default ->
                ...
                switch (player.iDMark.getIndexMenu()) {
                    ...
                    case ConstNpc.CONFIRM_REMOVE_ALL_ITEM_MAIL_BOX -> {
                        if (select == 0) {
                            ...
                            if (NNTSqlFetcher.updateMailBox(player)) {
