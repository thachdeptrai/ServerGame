    ...
    public boolean check(Player player, String text) {
        if (player.isAdmin()) {
            ...
            if (text.startsWith("dmg")) {
                try {
                    double dameg = Double.parseDouble(text.replaceAll("dmg", ""));
            ...
            if (text.startsWith("hpg")) {
                try {
                    double hpg = Double.parseDouble(text.replaceAll("hpg", ""));
            ...
            if (text.startsWith("mpg")) {
                try {
                    double mpg = Double.parseDouble(text.replaceAll("mpg", ""));
