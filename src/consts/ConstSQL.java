...
public class ConstSQL {
    ...
    public static final String TOP_HONGNGOC = "SELECT name, gender, items_body,CAST( total_hongngoc AS UNSIGNED) AS total_hongngoc FROM account, player WHERE account.id = player.account_id ORDER BY total_hongngoc DESC LIMIT 20;";
