...
public class ConstNpc {
    ...
    public static final byte TIENNHAN = 79;
    public static final byte THUONGNHAN = 80;
    public static final byte CAYTHONG = 99;
    public static final byte HOA_HONG = 104;
    public static final byte BULMA_THO = 109;
    public static final byte HISTORYTRADE = 110;
    //----------------------index menu------------------------------------------
...
//tranh ngọc
    ...
    public static final int ALL_IN_ONE_VANG = 600;/*telegram @tomihjhj_bot*/
    public static final int ALL_IN_ONE = 601;/*telegram @tomihjhj_bot*/
}
