...
import DBConnect.SingletonDatabase;
...
public class Nthach {
    ...
    public final static String SDT = "0867487105";
...
//    public final static int ID_TOPSM = 356;//SV1
    public final static String MANAP = "thachdeptrai ";
    public static String readInt = SingletonDatabase.getInstance().readFromDatabase();
