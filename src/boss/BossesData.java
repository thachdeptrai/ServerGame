...
public class BossesData {
    ...
    public static final BossData THIENDE = new BossData(
            "Thiên Đế ",
            ConstPlayer.TRAI_DAT,
            new short[]{1455, 1450, 1451, -1, -1, -1},
            100000,
            new double[]{15_000_000_000L},
            new int[]{184, 185, 186, 187},
            new int[][]{
                {Skill.DRAGON, Util.nextInt(1, 7), 1000},
                {Skill.KAIOKEN, Util.nextInt(1, 7), 1000},
                {Skill.KAMEJOKO, Util.nextInt(1, 7), 1000},
                {Skill.ANTOMIC, Util.nextInt(1, 7), 1000},
                {Skill.MASENKO, Util.nextInt(1, 7), 1000},
                {Skill.GALICK, Util.nextInt(1, 7), 1000},
                {Skill.LIEN_HOAN, 7, 1000},
                {Skill.THOI_MIEN, 3, 50000},
                {Skill.BIEN_KHI, Util.nextInt(1, 7), 500000},
                {Skill.SUPER_KAME, Util.nextInt(1, 7), 500000},
                {Skill.TAI_TAO_NANG_LUONG, Util.nextInt(1, 7), 500000},
                {Skill.LIEN_HOAN_CHUONG, Util.nextInt(1, 7), 500000},
                {Skill.DICH_CHUYEN_TUC_THOI, 3, 50000}},
            new String[]{"|-1|Trùm Cuối Đây"},
            new String[]{"|-1|Rác Rưởi vãi l cmmmmm"},
            new String[]{"|-1|Jack"},
            REST_15_M,
            new int[]{BossID.MATON, BossID.DUONGTANG, BossID.THIENMA, BossID.PHONGVAN});
    public static final BossData MATON = new BossData(
            "Ma Tôn ",
            ConstPlayer.TRAI_DAT,
            new short[]{1431, 1432, 1433, -1, -1, -1},
            70000,
            new double[]{10_000_000_000L},
            new int[]{184, 185, 186, 187},
            new int[][]{
                {Skill.DRAGON, Util.nextInt(1, 7), 1000},
                {Skill.KAIOKEN, Util.nextInt(1, 7), 1000},
                ...
                {Skill.LIEN_HOAN_CHUONG, Util.nextInt(1, 7), 500000},
                {Skill.DICH_CHUYEN_TUC_THOI, 3, 50000}},
            new String[]{"|-1|Họ Lào à"},
            new String[]{"|-1|Lào gì cũng tôn"},
            new String[]{"|-1|Jack"},
            AppearType.APPEAR_WITH_ANOTHER);
    public static final BossData PHONGVAN = new BossData(
            "Phong Vân ",
            ConstPlayer.TRAI_DAT,
            new short[]{1518, 1521, 1522, -1, -1, -1},
            100000,
            new double[]{15_000_000_000L},
            new int[]{184, 185, 186, 187},
            new int[][]{
    ...
    public static final BossData DUONGTANG = new BossData(
            ...
            new String[]{"|-1|Jack"},
            AppearType.APPEAR_WITH_ANOTHER);
    public static final BossData THIENMA =  new BossData(
                "Thiên Ma",
                ConstPlayer.TRAI_DAT,
                new short[]{1578, 1581, 1582, -1, -1, -1},
                90000,
                new double[]{15_000_000_000L},
                new int[]{184, 185, 186, 187},
                new int[][]{
...
//**************************************************************************
    ...
    public static final BossData CUMBER = new BossData(
            "Cumber", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1311, 1312, 1313, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            800000, //dame
    ...
    public static final BossData SUPER_CUMBER = new BossData(
            "Super Cumber", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1314, 1312, 1313, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new double[]{4000000000L}, //hp
            new int[]{155, 165}, //map join
            (int[][]) Util.addArray(FULL_GALICK, FULL_ANTOMIC, FULL_TDHS), //skill
    ...
    public static final BossData HEC_QUYN_EVENT = new BossData(
            ...
            (int[][]) Util.addArray(FULL_KAMEJOKO, FULL_GALICK), //skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Khà khà", "|-1|He he", "|-1|Chết nè"}, //text chat 2
            new String[]{}, //text chat 3
