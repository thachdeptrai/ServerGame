...
public class BossID {
    ...
    //=======================pgg=========================
    public static final int XINBATO_EVENT = -999;
    public static final int SOI_HEC_QUYN_EVENT = -1000;
    //========================MABU 2H========================
    ...
    //============================TIEN GIOI ===============================\\
    public static final int MATON = -369;
    public static final int DUONGTANG = -370;
    public static final int THIENMA = -375;
    public static final int PHONGVAN = -372;
    public static final int THIENDE = -374;
