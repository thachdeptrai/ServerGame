...
public class Zone {
    ...
    private void udPlayer() {
        for (int i = this.notBosses.size() - 1;/*telegram @tomihjhj_bot*/ i >= 0;/*telegram @tomihjhj_bot*/ i--) {
            Player pl = this.notBosses.get(i);/*telegram @tomihjhj_bot*/
            if (!pl.isPet && !pl.isBot && !pl.isNewPet) {
                this.notBosses.get(i).update();/*telegram @tomihjhj_bot*/
            }
        }
    }
